...
public class KafkaMoreThanFlink
{
            ...
            throws Exception
    {
        ...
        SingleOutputStreamOperator<UserEvent> kafkaSource = KafkaSourceUtil.createKafkaSource(env, "watermark_source", "kafka_more_flink");
